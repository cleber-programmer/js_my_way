describe('vText', () => {
  ...
  it('Passado um matrix para o vText, deve retornar um literal com a matrix informado', () => {
  ...
  it('Passado um objeto para o vText, deve retornar um literal com o objeto informado', () => {
  ...
  it('Passado uma data para o vText, deve retornar um literal com a data informado', () => {
